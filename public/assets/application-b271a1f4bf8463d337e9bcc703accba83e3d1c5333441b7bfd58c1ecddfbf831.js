...
$(function() {
  ...
  $('[data-elective-cat]').click(function(){
    ...
    var cse_title = $('[data-elective-cat="CSE"]').html().split('</i> ');
    cse_title[0] = '<i class="fa fa-plus">';
    $('[data-elective-cat="CSE"]').html(cse_title.join('</i> '));

    var cse_title = $('[data-elective-cat="NSE"]').html().split('</i> ');
    cse_title[0] = '<i class="fa fa-plus">';
    $('[data-elective-cat="NSE"]').html(cse_title.join('</i> '));

    var te_title = $('[data-elective-cat="TE"]').html().split('</i> ');
    te_title[0] = '<i class="fa fa-plus">';
    $('[data-elective-cat="TE"]').html(te_title.join('</i> '));
  ...
  $('[data-list]').click(function(){
    ...
    $('#listA, #listC, #listD, #list1, #list2, #list4A, #list4B, #listDesignProj, #listCE, #listEE').collapse('hide');
  });
